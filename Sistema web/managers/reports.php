...
// Obtener el rol/category del usuario logeado
$user_category = $_SESSION['technician_role'];
...
$page_title = 'Metrics Dashboard - ' . htmlspecialchars($user_category);
// Construir condiciones WHERE según los filtros
$whereConditions = [];
$queryParams = [];

// FILTRO POR ROL/CATEGORÍA DEL USUARIO - SIEMPRE SE APLICA
$whereConditions[] = "category = ?";
$queryParams[] = $user_category;
...
<head>
    ...
    <style>
        ...
        * { 
        ...
        /* Charts Grid Mejorado - CORREGIDO */
        .charts-grid {
            display: grid;
        ...
        @media print {
            ...
            /* Ajustes de diseño para impresión */
            body {
                background: white !important;
            ...
            /* Asegurar que los elementos no se corten en medio de una página */
            .card, .stats-grid, .table-container, .chart-container {
                page-break-inside: avoid;
                break-inside: avoid-page;
            }
            
            /* Charts grid en impresión */
            .charts-grid {
                grid-template-columns: 1fr !important;
                gap: 1rem !important;
                margin-bottom: 1rem !important;
            ...
            /* Añadir márgenes para impresión */
            @page {
                margin: 1cm;
                size: auto;
            }
            ...
            /* Mostrar información del período en impresión */
            .print-period-info {
                display: block !important;
                background: #f8f9fa;
                padding: 0.75rem;
        ...
        /* Ocultar elementos de impresión en vista normal */
...
<body>
    ...
    <div class="print-header">
        ...
        <div class="print-subtitle">Metrics and Analysis Dashboard - Department: <?php echo htmlspecialchars($user_category); ?></div>
    ...
    <div class="print-period-info">
        ...
        ?>
        | <strong>Department:</strong> <?php echo htmlspecialchars($user_category); ?>
    </div>
        ...
        <div class="header-content">
            <h1>
                ...
                <span class="department-badge">
                    <i class="fas fa-building"></i> <?php echo strtoupper($user_category); ?>
                </span>
            </h1>
            <p style="opacity: 0.9; font-size: 0.9rem;">
                Welcome, <strong><?php echo htmlspecialchars($_SESSION['technician_name']); ?></strong> • 
                Department: <strong><?php echo htmlspecialchars($user_category); ?></strong> • 
    ...
    <div class="admin-container">
        ...
        <div class="insight-card">
            <div class="insight-title">
                <i class="fas fa-lightbulb"></i> Key Department Insights
            </div>
            <p>Your department (<strong><?php echo htmlspecialchars($user_category); ?></strong>) shows a satisfaction rate of <strong><?php echo $metrics['satisfaction_rate']; ?>%</strong> 
        ...
        <div class="filters">
            <form id="filterForm" method="GET">
                <div class="filter-grid">
                    ...
                    <input type="hidden" id="departmentFilter" name="departmentFilter" value="<?php echo htmlspecialchars($user_category); ?>">
    ...
    <div class="print-footer">
        Report generated by Query System - Department: <?php echo htmlspecialchars($user_category); ?> | Page <span class="page-number"></span>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Configurar fecha máxima para el campo de fecha fin (hoy)
    ...
    function initializeCharts() {
        ...
        if (departmentCtx) {
            new Chart(departmentCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Consultas por Departamento',
        ...
        // 4. Gráfico de Preguntas Frecuentes
        ...
        // 5. Gráfico de Satisfacción (Radar)
        const satisfactionCtx = document.getElementById('satisfactionChart');
        if (satisfactionCtx) {
            new Chart(satisfactionCtx, {
                type: 'radar',
                data: {
                    labels: ['Tasa de Respuesta', 'Satisfacción', 'Eficiencia', 'Cobertura', 'Velocidad'],
                    datasets: [{
        ...
        // 6. Gráfico de Top Números Más Repetidos
    ...
    // Función para expandir texto de preguntas
    ...
    // ==================== VERIFICACIÓN DE ESTADO DE USUARIO CADA 30 SEGUNDOS ====================
    ...
    // Verificar estado inmediatamente al cargar la página
    document.addEventListener('DOMContentLoaded', function() {
        checkUserStatus();
    ...
    // Aplicar verificación a formularios importantes
    document.addEventListener('DOMContentLoaded', function() {
